...
**Refresh every open drafter tab once after an upgrade, then reopen the scout.** The page hook must attach to newly created connections. Confirm v0.4.1 in the header.
