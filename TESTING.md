...
Version 0.4.0 packages require loading the new extension folder/package and reopening the scouting window; refresh the drafter tab for normal live scouting.
